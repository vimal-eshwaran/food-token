...
const FoodCard = ({ cartlist, setCartlist, setCartClicked, foodImage, foodName, foodPrice, cartclicked, id }) => {
    ...
    const addCart = async (id) => {
        try {
            ...
            const response = await fetch(`https://foodtoken-backend-l2iv.onrender.com/cart/add/${id}`, {
                method: "POST",
                body: JSON.stringify(),
                headers: {
    ...
    const removeCart = async (id) => {
        ...
        try {
            ...
            const response = await fetch(`https://foodtoken-backend-l2iv.onrender.com/cart/delete/${findCart[0]._id}`, {
                method: "DELETE",
                headers: {
                    "x-auth-customertoken": localStorage.getItem("customertoken")
                }
