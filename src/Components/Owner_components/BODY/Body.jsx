    ...
    const fetchData = async () => {
      ...
      if (!ownerToken) {
        ...
        const foodResponse = await fetch(
          "https://foodtoken-backend-l2iv.onrender.com/owner/food",
          {
            method: "GET",
            headers: {
        ...
        const customerResponse = await fetch(
          "https://foodtoken-backend-l2iv.onrender.com/customers",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
        ...
        const ordersResponse = await fetch(
          "https://foodtoken-backend-l2iv.onrender.com/ownertoken",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
        ...
        const profitResponse = await fetch(
          "https://foodtoken-backend-l2iv.onrender.com/profit",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
